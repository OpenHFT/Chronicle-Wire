...
|Section 2_16, `IndentationDeterminesScope` | No | https://github.com/OpenHFT/Chronicle-Wire/#216-indentation-determines-scope[Section 2.16, Indentation determines scope]
