...
NOTE: You can parse all the expected fields (if any) and then parse any remaining fields. As YAML support object field "names" or keys these could be Strings or even Object as keys and values.
