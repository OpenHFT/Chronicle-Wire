...
== Yaml Specification Equivalent Operation in Chroncile-Wire

The section numbering below reflects that of the fix specification - see http://yaml.org/spec/1
.2/spec.html
