...
Peter Lawrey; Edits by Neil Clifford
:toc: manual
:css-signature: demo
...
== Uses of Chronical Wire

Chronical Wire can be used for:
...
Chronicle Wire supports `Java 8`.  Future versions may support `Java 6`, `C++` and `C#`.
