...
|Section 2_4, `SequenceOfMappings` | No |  https://github.com/OpenHFT/Chronicle-Wire/blob/master/README.adoc#24-sequence-of-mappings-players-statistics[Section 2.4, Sequence of Mappings]
...
|Section 2_9, `SingleDocumentWithTwoComments` | No | https://github.com/OpenHFT/Chronicle-Wire/blob/master/README.adoc#29-single-document-with-two-comments[]
