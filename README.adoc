...
2. reset all fields, so that
  ...
  b. there is specific built-in copy-by-value handling for some types such as `Bytes`
  c. all other fields will be copied by reference from the new instance to the existing instance
