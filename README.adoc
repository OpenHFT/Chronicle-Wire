...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=database-config-classes]
----
...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=basic-yaml-example]
----
...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=server-config-classes]
----
...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=object-anchor-example]
----
