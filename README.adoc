...
|2_7 TwoDocumentsInAStream | no |
|2_8 PlayByPlayFeed | no |
|2_9 SingleDocumentWithTwoComments | no |
|2_10 NodeAppearsTwiceInThisDocument | no |
|2_11 MappingBetweenSequences | no |
|2_12 CompactNestedMapping | no |
|2_13 InLiteralsNewlinesArePreserved | no |
|2_14 InThefoldedScalars | no |
|2_15 FoldedNewlines | no |
|2_16 IndentationDeterminesScope | no |
|2_17 QuotedScalars | no |
|2_18 Multi_lineFlowScalars | no |
|2_19 Integers | yes |
|2_20 FloatingPoint | yes |
|2_21 Miscellaneous | no |
|2_22 Timestamps | yes |
