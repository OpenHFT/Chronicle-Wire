...
|Section 2_4, `SequenceOfMappings` | No | https://github.com/OpenHFT/Chronicle-Wire/blob/master/README.adoc#sequence-of-mappings-player-statistics[Section 2.4, Sequence of Mappings]
