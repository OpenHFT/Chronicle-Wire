...
|===============
| Feature                     | Strict YAML Specoiification Compliance | Equivalent Operations in Chronicle Wire
|Section 2_1, `SequenceOfScalars` | Yes  |
|Section 2_2, `MappingScalarsToScalars` | Yes |
|Section 2_3, `MappingScalarsToSequences` | Yes |
|Section 2_4, `SequenceOfMappings` | No |  https://github.com/OpenHFT/Chronicle-Wire/blob/master/README.adoc#24--sequence-of-mappings
