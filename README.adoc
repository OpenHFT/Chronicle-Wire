...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=database-config-classes, indent=0]
----
...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=basic-yaml-example, indent=0]
----

=== Object Anchors

You can also anchor entire objects:

==== Server Config Classes

[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=server-config-classes, indent=0]
----
...
[source,java]
----
include::src/test/java/net/openhft/chronicle/wire/YamlAnchorExamplesTest.java[tags=object-anchor-example, indent=0]
----
