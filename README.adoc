...
|Section 2_4, `SequenceOfMappings` | No | https://github.com/OpenHFT/Chronicle-Wire/blob/master/README.adoc#24--sequence-of-mappings-player-statistics-1[Section 2.4, Sequence of Mappings]
...
|Section 2_16, `IndentationDeterminesScope` | No | https://github.com/OpenHFT/Chronicle-Wire/blob/master/README.adoc#216--indentation-determines-scope-1[Indentation determines scope]
...
=== Sequence of Mappings (player statistics)
