...
## Snake YAML
Snake YAML is a fully featured YAML 1.1 parser. It has to do much more work to support all the features of the standard which necessarily takes longer.

If you need to decode YAML which could come from any sources, Snake YAML is a better choice for this reason.
