...
and highlights any deviations.
It is intended for developers who require
...
| Anchors (`&`) & Aliases (`_`) | 3.2.2.2, 7.1, Example 2.10 | *_Yes** | Allows repeated nodes and object graphs with cycles or shared references.
