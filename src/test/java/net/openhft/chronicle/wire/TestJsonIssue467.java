...
public class TestJsonIssue467 {
    ...
    public void test() {
        ...
        ResponseItem467 responseItem = Marshallable.fromString(ResponseItem467.class, "!ResponseItem467 {\n" +
                "  index: \"4ab100000005\",\n" +
                "  key: seqNumber,\n" +
                "  payload: {\n" +
    ...
    public void testWireObject() {
        ...
        ResponseItem467 responseItem = jsonWire.getValueIn().object(ResponseItem467.class);
    ...
    public void testWireReusingObject() {
        final Wire jsonWire = jsonResponseItem();
        ResponseItem467 responseItem1 = new ResponseItem467();
        ResponseItem467 responseItem = jsonWire.getValueIn().object(responseItem1, ResponseItem467.class);
        Assert.assertEquals("!ResponseItem467 {\n" +
                "  index: \"4dc800000034\",\n" +
                "  key: notificationMsg,\n" +
                "  payload: Successfully debited your account by 0.0\n" +
