 ...
 */
       ...
       // System.out.println(Wires.fromSizePrefixedBlobs(bytes));
        assertEquals("[pos: 0, rlim: 128, wlim: 2147483632, cap: 2147483632 ] ǁ" +
        ...
        assertEquals("[pos: 0, rlim: 66, wlim: 2147483632, cap: 2147483632 ] ǁ" +
...
*/
        ...
        assertEquals("--- !!meta-data\n" +
                        ...
                        "}\n",
                Wires.fromSizePrefixedBlobs(bytes));
        assertEquals("[pos: 0, rlim: 143, wlim: 2147483632, cap: 2147483632 ] ǁ" +
       ...
       // System.out.println(Wires.fromSizePrefixedBlobs(bytes));
        assertEquals("[pos: 0, rlim: 116, wlim: 2147483632, cap: 2147483632 ] ǁ" +
        ...
        clear(bytes);
        writeMessageTwo(raw);
        assertEquals("[pos: 0, rlim: 91, wlim: 2147483632, cap: 2147483632 ] ǁ" +
