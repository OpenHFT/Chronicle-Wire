...
public class TimestampLongConverterZonedIdsConfigTest {
    ...
    public void timezoneCanBeConfiguredWithSystemPropertyForMilliseconds() {
        ...
        assertEquals("2020-09-18T11:02:03.123 Australia/Melbourne", new MilliTimestampLongConverter().asString(timestamp));
    }
    ...
    public void timezoneCanBeConfiguredWithSystemPropertyForMicroseconds() {
        ...
        assertEquals("2020-09-17T21:02:03.123456 America/Indiana/Indianapolis", new MicroTimestampLongConverter().asString(timestamp));
    }
    ...
    public void timezoneCanBeConfiguredWithLegacySystemPropertyForMicroseconds() {
        ...
        assertEquals("2020-09-18T03:02:03.123456 Europe/Paris", new MicroTimestampLongConverter().asString(timestamp));
    }
    ...
    public void timezoneCanBeConfiguredWithSystemPropertyForNanoseconds() {
        ...
        assertEquals("2020-09-18T08:02:03.123456789 Asia/Ho_Chi_Minh", new NanoTimestampLongConverter().asString(timestamp));
    }
}
