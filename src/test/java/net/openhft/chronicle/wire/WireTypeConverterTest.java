...
public class WireTypeConverterTest extends net.openhft.chronicle.wire.WireTestCommon {
    ...
    private final String jsonUnknownClass = "{\"@net.openhft.chronicle.wire.UnknownClass\":{\"msg\":\"msg:\\\"hello\\\"\"}}";
    private final String yamlUnknownClass = "!net.openhft.chronicle.wire.UnknownClass {\n" +
            "  msg: \"msg:\\\"hello\\\"\"\n" +
            "}\n";
    ...
    public void testYamlToJsonUnknownClass() throws Exception {
        expectException("Unable to find net.openhft.chronicle.wire.UnknownClass");
    ...
    public void testYamlClassCastException() throws Exception {
        new WireTypeConverter().yamlToJson("!net.openhft.chronicle.wire.MyClass2 {\n" +
    ...
    public void testJsonClassCastException() throws Exception {
        new WireTypeConverter().jsonToYaml("{\"@net.openhft.chronicle.wire.MyClass2\": {\n" +
