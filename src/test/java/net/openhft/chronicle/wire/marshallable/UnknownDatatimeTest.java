...
/**
 * Verifies that unknown datetime fields are ignored safely during deserialisation.
 */
class UnknownDatatimeTest extends WireTestCommon {
     ...
     */
    @Test
    @DisplayName("Unknown datetime fields do not break deserialisation")
    void ignoreAnUnknownDateTime() {
        ...
        assertEquals(123456, aClass.id, "Deserialised id should match the provided value");
    }
}
