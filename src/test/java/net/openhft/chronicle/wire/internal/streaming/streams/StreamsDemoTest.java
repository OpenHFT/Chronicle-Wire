package net.openhft.chronicle.wire.internal.streaming.streams;
...
import net.openhft.chronicle.wire.internal.streaming.Streams;
import net.openhft.chronicle.wire.internal.streaming.ToLongDocumentExtractor;
import net.openhft.chronicle.wire.internal.streaming.reduction.MarketData;
...
import static net.openhft.chronicle.wire.internal.streaming.CreateUtil.*;
...
class StreamsDemoTest {
    ...
    void streamTypeMarketData() {
        ...
        Map<String, List<MarketData>> groups = Streams.of(in, DocumentExtractor.builder(MarketData.class).build())
