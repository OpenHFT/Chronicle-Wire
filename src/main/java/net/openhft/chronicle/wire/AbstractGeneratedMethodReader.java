 ...
 * Provides shared utilities and state management for the runtime generated
 * implementations.
 */
public abstract class AbstractGeneratedMethodReader implements MethodReader {
    ...
    /**
     * Helper for generated readers that wish to reuse objects when reading.
     * Collections and maps are cleared; {@link AbstractMarshallableCfg} objects
     * are reset. Arrays and {@code null} return {@code null} to signal a new
    ...
    /**
     * Performs the reflective invocation used by generated code or interceptors.
     */
    ...
    /**
     * Lazily obtains the thread local {@link MessageHistory} instance.
     */
    ...
    private static final class MessageHistoryThreadLocal {
        ...
        /**
         * Swaps the thread local value and returns the previous instance.
         */
