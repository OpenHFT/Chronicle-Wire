...
graph TD
    subgraph "Schema Evolution Overview"
        A[Schema<br/> Changes] --> B{Type of<br/> Change}
        B -->|Add Field| C[Forward<br/> Compatible]
        B -->|Remove Field| D[Backward<br/> Compatible]
        B -->|Rename Field| E[Needs Special<br/> Handling]
        B -->|Change Type| F[Complex -<br/> May Need Custom Logic]
        
        C -->|"Older<br/> Reader"| G[Ignores <br/>Unknown Fields]
        D -->|"Newer<br/> Reader"| H[Uses <br/>Default Values]
        E -->|"@FieldNumber or<br/> Rename Map"| I[Maps Old <br/>Name to New]
        F -->|"Custom <br/>readMarshallable"| J[Custom <br/>Conversion Logic]
        
        K[Wire Format] --> L{Compatibility<br/> Level}
        L -->|"YAML/JSON/<br/>BINARY_LIGHT"| M[Good Schema<br/> Evolution]
        L -->|"FIELDLESS_BINARY"| N[Limited/<br/>No Evolution]
    end
----
