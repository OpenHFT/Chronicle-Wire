...
[glossaryentry]
ASCII-7 ::
A 7-bit character encoding standard representing 128 characters, primarily English letters, digits, and common punctuation. Often used as a subset of ISO-8859-1 to keep text-based wire formats universally readable.
